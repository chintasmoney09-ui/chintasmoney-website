  ...
  function seed() {
    return {
      ...
      trades: [
        ...
        T({ id: "s3", symbol: "RELIANCE", side: "Buy", qty: 100, entry: 2850, exit: 2872, date: iso(2),  setup: "Momentum", plannedSL: 2820, target: 2950, exit_reason: "Booked early (fear)", emotion: "Fear" }),
        T({ id: "s4", symbol: "TATASTEEL", side: "Sell", qty: 200, entry: 148, exit: 151, date: iso(3),  setup: "Scalp",    plannedSL: 150, target: 142, exit_reason: "Hit stop-loss",     emotion: "Calm" }),
        T({ id: "s5", symbol: "NIFTY 24600 CE", side: "Buy", qty: 50, entry: 88, exit: 60, date: iso(3),  setup: "FOMO",     plannedSL: null, target: null, exit_reason: "FOMO exit",         emotion: "FOMO" }),
        T({ id: "s6", symbol: "HDFCBANK", side: "Buy", qty: 50, entry: 1500, exit: 1548, date: iso(5),  setup: "Breakout", plannedSL: 1480, target: 1550, exit_reason: "Hit target",         emotion: "Calm" }),
        T({ id: "s7", symbol: "BANKNIFTY 50500 CE", side: "Buy", qty: 45, entry: 175, exit: 120, date: iso(6),  setup: "Reversal", plannedSL: 150, target: 250, exit_reason: "Held too long (greed)", emotion: "Greed" }),
        T({ id: "s8", symbol: "INFY", side: "Buy", qty: 80, entry: 1620, exit: 1641, date: iso(7),  setup: "Trend-follow", plannedSL: 1600, target: 1660, exit_reason: "Hit target",     emotion: "Calm" }),
        T({ id: "s9", symbol: "NIFTY 24400 PE", side: "Buy", qty: 50, entry: 95, exit: 70, date: iso(8),  setup: "Scalp",    plannedSL: null, target: null, exit_reason: "Bored/random",      emotion: "Overconfident" }),
        T({ id: "s10", symbol: "ADANIENT", side: "Buy", qty: 40, entry: 2900, exit: 2985, date: iso(10), setup: "Momentum", plannedSL: 2850, target: 3000, exit_reason: "Hit target",       emotion: "Calm" }),
        T({ id: "s11", symbol: "BANKNIFTY 51500 PE", side: "Buy", qty: 30, entry: 240, exit: 300, date: iso(12), setup: "Breakout", plannedSL: 200, target: 320, exit_reason: "Hit target",  emotion: "Calm" }),
        T({ id: "s12", symbol: "SBIN", side: "Sell", qty: 150, entry: 820, exit: 835, date: iso(14), setup: "Reversal", plannedSL: null, target: 790, exit_reason: "Revenge exit",          emotion: "Revenge" })
      ]
    };
  }
